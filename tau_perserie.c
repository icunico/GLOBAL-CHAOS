...
int main(int argc, char** argv) {
    ...
    printf("[Rank %d] Processando punti %d - %d (totale: %d)\n", 
    ...
    if (rank == 0) {
        ...
        global_lats = (double*)malloc(total_points * sizeof(double));
        global_lons = (double*)malloc(total_points * sizeof(double));
    }
    ...
    if (rank == 0) {
        ...
        printf("Punti validi: %d (%.1f%%)\n", 
               valid_count, 100.0 * valid_count / total_points);
