...
dxvalue=np.linspace(100, 700, 3) 
dcvalue=np.linspace(0.25, 1.0, 3)
...
for i in range(len(dxvalue)):
	for j in range(len(dcvalue)):
		...
		y = sol.y.T
		#t = t_eval
		specie_da_controllare_nomi= ['P1/DW1','C1/DWC1'] #['N', 'P1', 'P2', 'P3', 'C1', 'C2', 'X1', 'Y1', 'Z1' 'D']
