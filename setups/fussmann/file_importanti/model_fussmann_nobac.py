...
dx_values = np.linspace(0.1, 0.45, 70)
dc_values = np.linspace(0.1, 1.2, 70)
...
for dx in dx_values:
    for dc in dc_values:
       ...
       # Condizioni iniziali
        ...
        initial_conditions = [0.5, 0.5, 0.5, 0.5, 0.0, 0.5, 0.0, 0.0, 0.5, 2.0]
        ...
        specie_da_controllare= [0, 1, 2, 3, 5] #['P1', 'P2', 'P3', 'C1', 'C2', 'X1', 'Y1', $
        flag_neg = False
