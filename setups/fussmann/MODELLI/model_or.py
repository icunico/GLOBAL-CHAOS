...
model = pyfabm.Model('fabm_new.yaml')
...
sol = scipy.integrate.solve_ivp(dy, [0., t_ex], model.state, t_eval=t_eval, max_step=2500)
...
#variables_to_track = ['P1/DW1', 'C1/DWC1', 'C1/DWC2']  # Variabili di interesse
variables_to_track = [ 'P1/DW1', 'C1/DWC1', 'C1/DWC2', 'X/DWX1', 'P1/DW2', 'P1/DW3']  
