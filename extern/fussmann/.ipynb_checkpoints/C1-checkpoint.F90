...
module fussmann_C1
   ...
   type, extends(type_base_model), public :: type_fussmann_C1
      ...
      ! Model parameters
      real(rk) :: aP1C1,bP1C1,aP2C1,bP2C1,aP3C1,bP3C1,aP1C2,bP1C2,aP2C2,bP2C2,aP3C2,bP3C2
   contains
...
contains
   ...
   subroutine do(self, _ARGUMENTS_DO_)
      ...
      _LOOP_BEGIN_
         ...
         lvC1 = C1 * ( (self%aP1C1*P1+self%aP2C1*P2+self%aP3C1*P3) / (1.0+self%bP1C1*P1+self%bP2C1*P2+self%bP3C1*P3))
         lvC2 = C2 * ( (self%aP1C2*P1+self%aP2C2*P2+self%aP3C2*P3) / (1.0+self%bP1C2*P1+self%bP2C2*P2+self%bP3C2*P3))
