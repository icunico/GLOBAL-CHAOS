...
module fussmann_X
   ...
   type, extends(type_base_model), public :: type_fussmann_X
      ...
      ! Model parameters
      real(rk) :: aP1X1,bP1X1, aP2X1,bP2X1, aP3X1,bP3X1, aC1X1,bC1X1,aC2X1,bC2X1
   contains
...
contains
   ...
   subroutine do(self, _ARGUMENTS_DO_)
      ...
      _LOOP_BEGIN_
         ...
         lvX1 = X1 * ( (self%aP1X1*P1+self%aP2X1*P2+self%aP3X1*P3+self%aC1X1*C1+self%aC2X1*C2) / (1.0+self%bP1X1*P1+self%bP2X1*P2+self%bP3X1*P3+self%bC1X1*C1+self%bC2X1*C2))
