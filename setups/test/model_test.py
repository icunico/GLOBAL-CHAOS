...
model = pyfabm.Model('fabm_simp.yaml')
...
t_eval = np.linspace(0, 3650.*5006400, 10000) 
#t_eval = np.linspace(0, 3650.*5006400, 300000) 
sol = scipy.integrate.solve_ivp(dy, [0., 3650.*5006400], model.state, 
t_eval=t_eval)
#y = scipy.integrate.odeint(dy, model.state, t*186400)
