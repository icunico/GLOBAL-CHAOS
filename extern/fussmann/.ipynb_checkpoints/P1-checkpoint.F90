...
contains
   ...
   subroutine initialize(self, configunit)
      ...
      call self%register_state_dependency(self%id_N1, 'DWN1', 'd-1', 'nutrients')
...
!      call self%register_diagnostic_variable(self%id_lvprey2,  'growth2', 'd-2', 'growth rate')
   ...
   subroutine do(self, _ARGUMENTS_DO_)
      ...
      _LOOP_BEGIN_
         ...
         lvP1 = P1*self%r1*N1/(N1+self%K1)
         lvP2 = P2*self%r2*N1/(N1+self%K2)
         lvP3 = P3*self%r3*N1/(N1+self%K3)
         _SET_ODE_(self%id_P1, lvP1)
         _SET_ODE_(self%id_P2, lvP2)
         _SET_ODE_(self%id_P3, lvP3)
         _SET_ODE_(self%id_N1, -(lvP1+lvP2+lvP3))
