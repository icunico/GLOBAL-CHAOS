...
model = pyfabm.Model('fabm_bacterialoop.yaml')
...
variables_to_track = ['P3/c', 'R2/c', 'O3/c']  # Variabili di interesse
#variables_to_track = [ 'X1/c', 'X2/c', 'R1/c', 'R2/c', 'R3/c', 'R6/c', 'R8/c']  # Variabili di interesse
