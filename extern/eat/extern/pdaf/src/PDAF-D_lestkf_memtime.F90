...
!
!$Id: PDAF-D_lestkf_memtime.F90 756 2021-03-31 17:57:51Z lnerger $
!BOP
!
...
! **************************************
     ...
     IF (filterpe) THEN
        ...
        WRITE (*, '(a, 18x, a, F11.3, 1x, a)') 'PDAF', 'LESTKF analysis:', pdaf_time_tot(3), 's'
...
! *******************************************************
     ...
     IF (filterpe) THEN
        ! Filter-specific part
        WRITE (*, '(a, 10x, a, 15x, F11.3, 1x, a)') 'PDAF', 'LESTKF analysis:', pdaf_time_tot(3), 's'
